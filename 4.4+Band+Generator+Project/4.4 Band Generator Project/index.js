...
app.post("/submit", (req, res) => {
  ...
  const rand_adjetive = adj[Math.floor(Math.random() * adj.length)];
  const rand_noun = noun[Math.floor(Math.random() * noun.length)];
  const band = rand_adjetive + " " + rand_noun;
  res.render("index.ejs", { name: band });
});
